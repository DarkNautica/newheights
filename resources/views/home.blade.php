...
{{-- Custom CSS for the gradient text and text-only shine effect --}}
@section('styles')
<style>
.gradient-shine {
  position: relative;
  overflow: visible; /* allow extra vertical space */
  display: inline-block;
  background: linear-gradient(90deg, #EF4339, #D12C24);
  background-clip: text;
  -webkit-background-clip: text;
  color: transparent;
  line-height: 1.1;      /* Increase the line-height to provide more space */
  padding-bottom: 0.1em; /* Add some extra bottom padding if needed */
}
.gradient-shine::after {
  ...
  left: 0;
  width: 100%;
  height: 110%;  /* This makes sure the shine gradient covers extra vertical space */
  background: linear-gradient(120deg, transparent, rgba(255, 225, 225, 0.8), transparent);
  background-clip: text;
  -webkit-background-clip: text;
  color: transparent;
...
<section class="relative w-full h-screen overflow-hidden">
  ...
  <div class="relative z-10 px-6 mx-auto max-w-screen-2xl text-center py-24 lg:py-80">
    <h1 class="mb-4 text-4x1 font-extrabold tracking-tight leading-none text-white md:text-5xl lg:text-6xl">
      Building a Legacy, 
      <span class="gradient-shine" data-text="Brick by Brick">Brick by Brick</span>
    </h1>
...
<section class="relative bg-gradient-to-b from-white/30 to-white/50 py-24">
  <!-- Content Wrapper -->
  <div class="relative z-10 px-6 mx-auto max-w-screen-xl lg:px-8">
      <div class="shadow-xl rounded-xl p-8 lg:p-12 bg-white/90">
          <div class="gap-16 items-center lg:grid lg:grid-cols-2">
              <div class="font-light text-gray-700 sm:text-lg">
                  ...
                  <p class="mb-6 leading-relaxed">
                      To be the most trusted family-run construction company in Asheville, where clients can rely on our integrity and dedication to navigate challenges, fostering lasting relationships built on transparency and exceptional service.
                  </p>
                  <p class="leading-relaxed">
                      To provide exceptional construction services for homes and businesses, fostering trust through integrity and dedication. We are committed to supporting our clients through every challenge, ensuring a seamless experience with craftsmanship that prioritizes thoroughness and care.
                  </p>
              </div>
  ...
  <section class="bg-gradient-to-b from-white/50 to-white/70 py-24" py-24 relative">
    <div class="max-w-screen-xl px-4 mx-auto lg:py-16 lg:px-6 relative z-10 flex items-center">
      ...
      <div class="lg:w-2/3 text-center lg:text-left ml-auto relative z-20 bg-white p-8 rounded-lg shadow-lg">
  ...
  <!-- Unified Section: Our Work -->
  <section class="bg-white/70 py-24 relative">
    <div class="max-w-screen-xl px-6 mx-auto text-center">
      ...
      <div id="work-carousel" class="relative w-full mx-auto max-w-4xl" data-carousel="slide">
        ...
        <!-- Carousel Navigation -->
        <button type="button" class="absolute top-1/2 left-4 transform -translate-y-1/2 z-30 flex items-center justify-center h-12 w-12 rounded-full bg-white hover:bg-white shadow-lg transition-all"
                data-carousel-prev>
        ...
        <button type="button" class="absolute top-1/2 right-4 transform -translate-y-1/2 z-30 flex items-center justify-center h-12 w-12 rounded-full bg-white hover:bg-white shadow-lg transition-all"
                data-carousel-next>
          <svg class="w-6 h-6 text-gray-700" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  <!-- Call to Action Section with a Gradient Blending from White (70% opacity) to White (100% opacity) -->
  <section class="bg-gradient-to-b from-white/70 to-white/100 py-24">
    <div class="py-8 px-6 mx-auto max-w-screen-xl sm:py-16 lg:px-8">
      <div class="max-w-screen-md text-center lg:text-left">
        <h2 class="mb-6 text-4xl tracking-tight font-extrabold text-[#EF4339]">
          Constructing Excellence Together
        </h2>
        <p class="mb-8 font-light text-gray-700 text-lg sm:text-xl">
          At NEW HEIGHTS™, we transform visions into enduring structures. Our experienced team blends innovative design with quality craftsmanship to create spaces that not only stand the test of time but also inspire future generations. Let's build your next masterpiece.
        </p>
        <div class="flex flex-col space-y-4 sm:flex-row sm:space-y-0 sm:space-x-6 justify-center lg:justify-start">
          <a href="#"
             class="inline-flex items-center justify-center px-6 py-3 text-base font-medium text-white bg-[#EF4339] rounded-lg shadow hover:bg-opacity-90 focus:ring-4 focus:ring-[#EF4339] focus:ring-opacity-50">
            Get Started
          </a>
          <a href="#"
             class="inline-flex items-center justify-center px-6 py-3 text-base font-medium text-[#EF4339] border border-[#EF4339] rounded-lg hover:bg-[#EF4339] hover:text-white focus:ring-4 focus:ring-[#EF4339] focus:ring-opacity-30">
